...
export default {
  ...
  activeTab: platform === PLATFORM.IOS ? '#DC143C' : '#fff',
  sTabBarActiveTextColor: '#DC143C',
  tabBarActiveTextColor: platform === PLATFORM.IOS ? '#DC143C' : '#fff',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#3F51B5',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#DC143C' : '#fff',
  ...
  toolbarBtnTextColor: platform === PLATFORM.IOS ? '#DC143C' : '#fff',
  ...
  listItemSelected: platform === PLATFORM.IOS ? '#DC143C' : '#3F51B5',
  ...
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? '#DC143C' : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? '#DC143C' : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#3F51B5',
  segmentBorderColor: platform === PLATFORM.IOS ? '#DC143C' : '#fff',
  ...
  topTabBarActiveTextColor: platform === PLATFORM.IOS ? '#DC143C' : '#fff',
  topTabBarBorderColor: platform === PLATFORM.IOS ? '#a7a6ab' : '#fff',
  topTabBarActiveBorderColor: platform === PLATFORM.IOS ? '#DC143C' : '#fff',
